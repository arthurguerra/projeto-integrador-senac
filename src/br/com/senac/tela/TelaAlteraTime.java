...
public class TelaAlteraTime extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtTimes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtTimesMouseClicked(evt);
            }
        });
        jtTimes.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jtTimesKeyReleased(evt);
            }
        });
    ...
    private void jtTimesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtTimesMouseClicked
        // TODO add your handling code here:
        if (jtTimes.getSelectedRow() != -1) {
            txtNome.setText(jtTimes.getValueAt(jtTimes.getSelectedRow(), 0).toString());

        }
    }//GEN-LAST:event_jtTimesMouseClicked

    private void jtTimesKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtTimesKeyReleased
        if (jtTimes.getSelectedRow() != -1) {
            txtNome.setText(jtTimes.getValueAt(jtTimes.getSelectedRow(), 0).toString());

        }
    }//GEN-LAST:event_jtTimesKeyReleased
   ...
   public void busca(String desc) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlteraTime.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
